...
public class Basics {
    ...
    public static void main(final String[] args) {
        ...
        /* DONE-ODO (Task 1): Write a line of code below that prints the string
         *                Hello World!
         */
        ...
        /*
         * DONE-ODO (Task 2): Create a variable named my_variable and assign it the
         *                value 100.
         */
        int my_variable = 100;
        ...
        /*
         * DONE-ODO (Task 3): Create a for-loop that loops from 10 to 0, printing
